...
export default function HRApplicationsPage() {
  ...
  const fetchApplications = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:3001"}/applications?${queryParams}`,
        {
  ...
  const handleStatusChange = async (
    ...
    try {
      const token = localStorage.getItem("access_token");
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:3001"}/applications/${applicationId}/status`,
        {
          method: "POST",
          headers: {
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Quản lý và xem xét các đơn ứng tuyển cho công ty của bạn.
                </p>
              </div>
            </div>
          </div>
                            ...
                            <div className="flex items-start justify-between mb-4">
                              <div>
                                ...
                                {application.jobSeekerProfile.skills &&
                                  application.jobSeekerProfile.skills.length >
                                    0 && (
                  ...
                  <div className="space-y-4">
                    <div className="text-center">
                      ...
                      <h4 className="font-semibold text-lg">
                        {selectedApplication.jobSeekerProfile.fullName}
                      </h4>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3 text-sm">
                        ...
                        <span>
                          {selectedApplication.jobSeekerProfile.email}
                        </span>
                      </div>
                    ...
                    {selectedApplication.jobSeekerProfile.skills &&
                      selectedApplication.jobSeekerProfile.skills.length >
                        0 && (
                        <div>
                          <h5 className="font-medium mb-2">Kỹ năng</h5>
                          <div className="flex flex-wrap gap-1">
                            {selectedApplication.jobSeekerProfile.skills.map(
                              (skill, index) => (
                                <Badge
                                  key={index}
                                  variant="secondary"
                    ...
                    <div className="pt-4 border-t space-y-2">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <span>Mức lương:</span>
                        <span className="font-medium text-green-600">
                          {formatSalaryDisplay(selectedApplication.job.salary)}
                        </span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
